...
# ========================================================================
cutadapt -b file:/storage/vital/volume1/carol/influenza/pipeline/primer_and_adapter_colection.fasta -B file:/storage/vital/volume1/carol/influenza/pipeline/primer_and_adapter_colection.fasta -j 10 -o ${F}_R1_cutadapt.fq.gz -p ${F}_R2_cutadapt.fq.gz ${F}_R1.fq.gz ${F}_R2.fq.gz
...
# ========================================================================
cat /storage/vital/volume1/carol/influenza/pipeline/segment_list.txt \
| xargs -P 8 -I {} sh -c 'N=$(cat sample_name.txt); /project/carol/influenza/pipeline/software/vapor/vapor.py -fa /storage/vital/volume1/carol/influenza/pipeline/segments_database/{}.fasta -fq "$N"_R1_paired.fq.gz "$N"_R2_paired.fq.gz | cut -f 6 | sed "s/>//g" > {}_result.txt'
...
# ========================================================================
cat /storage/vital/volume1/carol/influenza/pipeline/segment_list.txt | xargs -P 8 -I {} sh -c 'seqtk subseq /storage/vital/volume1/carol/influenza/pipeline/segments_database/{}.fasta {}_result.txt> {}_ref.fasta'
...
for i in 1 2 3 4 5 6 7 8; do
    ...
    if [ -s segment_${i}_result.txt ]; then
        ...
        if test -f SPAdes_segment${i}/scaffolds.fasta; then
            ...
            python /storage/vital/volume1/carol/influenza/pipeline/substitute_degenarate_bases.py minimap_segment_${i}_preconsensus.fa minimap_segment_${i}_preconsensus_fixed.fa
            ...
            python /storage/vital/volume1/carol/influenza/pipeline/substitute_degenarate_bases.py segment_${i}_${F}_ivar.fa segments/segment_${i}_${F}.fasta
            ...
            if [ $(cat H_genotype.txt) == "H1" ] && [ $i -eq 4 ]; then
                nextclade run -D /storage/vital/volume1/carol/influenza/pipeline/nextclade_files/H1 -j 10 -t nextclade.tsv segments/segment_${i}_${F}.fasta
                csvcut -t -c clade nextclade.tsv | tail -n+2 > clade.txt
            elif [ $(cat H_genotype.txt) == "H3" ] && [ $i -eq 4 ]; then
                nextclade run -D /storage/vital/volume1/carol/influenza/pipeline/nextclade_files/H3 -j 10 -t nextclade.tsv segments/segment_${i}_${F}.fasta
                csvcut -t -c clade nextclade.tsv | tail -n+2 > clade.txt
            elif [ $(cat H_genotype.txt) == "Victoria" ] && [ $i -eq 4 ]; then
                nextclade run -D /storage/vital/volume1/carol/influenza/pipeline/nextclade_files/Vic -j 10 -t nextclade.tsv segments/segment_${i}_${F}.fasta
                csvcut -t -c clade nextclade.tsv | tail -n+2 > clade.txt
            elif [ $(cat H_genotype.txt) == "Yamagata" ] && [ $i -eq 4 ]; then
                nextclade run -D /storage/vital/volume1/carol/influenza/pipeline/nextclade_files/Yam -j 10 -t nextclade.tsv segments/segment_${i}_${F}.fasta
                csvcut -t -c clade nextclade.tsv | tail -n+2 > clade.txt
            elif [ $i -eq 4 ]; then
